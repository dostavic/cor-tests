...
TEST(struct, test_initialization){
	...
	EXPECT_EQ(sd.outputFolder, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/");
...
TEST(struct, test_initialization_5){
	...
	EXPECT_EQ(sd.outfilPrefix, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/");
	EXPECT_EQ(sd.cutOffRigPrefix, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/cut_off_rig.dat");
	EXPECT_EQ(sd.intensityYieldPrefix, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/intensity_yield.dat");
	EXPECT_EQ(sd.map, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/mapa_over_atm_4x.dat");
	EXPECT_EQ(sd.integr2sum, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/integr2sum");
	EXPECT_EQ(sd.spectraBands, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/spectraBands");
	EXPECT_EQ(sd.outfil_0, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/outfil_0");
	EXPECT_EQ(sd.throughputPath, "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/throughputs.dat");
}
...
TEST(struct, test_initialization_6){
	...
	EXPECT_EQ(sd.rigEnergyFile, "./tst/Asmp/PostProcessingSpectra/ForceField/rig_to_energy.dat");
	EXPECT_EQ(sd.energyDivider, 1);
...
TEST(struct, test_initialization_7){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_metadata/ForceField/"
	};
...
TEST(struct, test_initialization_8){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_main_file/ForceField/"
	};
...
TEST(struct, test_initialization_9){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_spectrm_range_scaling/ForceField/"
	};
...
TEST(struct, test_initialization_10){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_RigEnergyCorespondence/ForceField/"
	};
...
TEST(struct, test_initialization_11){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_energyDivider/ForceField/"
	};
...
TEST(struct, test_initialization_12){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_intensityDivider/ForceField/"
	};
...
TEST(struct, test_initialization_13){
	...
	char* argv[] = {
		...
		(char*)"./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/",
		(char*)"1",
		(char*)"./tst/Asmp/PostProcessingSpectra_dateRange/ForceField/"
	};
...
TEST(struct_1, test_initialization_1){
	std::string outfil_0 = "./tst/Asmp/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/outfil_0";
...
TEST(struct_1, test_initialization_2){
	std::string outfil_0 = "./tst/Asmp/test_outfil/outfil_0";
...
TEST(struct_1, test_initialization_3){
	std::string outfil_0 = "./tst/Asmp/test_outfil/outfil_01";
...
TEST(struct_1, test_initialization_4){
	std::string outfil_0 = "./tst/Asmp/test_outfil/outfil_0_year";
...
TEST(struct_1, test_initialization_5){
	std::string outfil_0 = "./tst/Asmp/test_outfil/outfil_0__";
...
TEST(struct_1, test_initialization_6){
	std::string outfil_0 = "./tst/Asmp/test_outfil/outfil_0_none";
