...
TEST(struct_DataVectors_function, test_readOutfil_1){
    ...
    char* argv[] = {
		(char*)"./AmsP",
		(char*)"./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0_11lines/",
		(char*)"1",
		(char*)"null"
	};
    StaticData consts(argc, argv);
...
TEST(struct_DataVectors_function, test_readOutfil_2){
    ...
    char* argv[] = {
		(char*)"./AmsP",
		(char*)"./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0_256/",
		(char*)"1",
		(char*)"null"
	};
    StaticData consts(argc, argv);
...
TEST(struct_DataVectors_function, test_writeCAY_ff){
    ...
    FILE *f = fopen("./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/cut_off_rig.dat", "r");
...
TEST(struct_DataVectors_function, test_writeCAY_dd){
    ...
    FILE *d = fopen("./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/intensity_yield.dat", "r");
...
TEST(struct_DataVectors_function, test_writeMaps){
    ...
    FILE *g = fopen("./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/mapa_over_atm_4x.dat", "r");
...
TEST(struct_DataVectors_function, test_writeSpectraBands){
    ...
    FILE *z = fopen("./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/spectraBands", "r");
...
TEST(struct_DataVectors_function, test_writeIntegr2sum){
    ...
    FILE *z = fopen("./tst/2003_326_23_41.90_12.47_1.00_1_0.01_1_0/integr2sum", "r");
